...
//    }
	...
	public UsersDto selectIUser(Long userNum) {
		...
		return users != null ? UsersDto.fromEntity(users) : null;
	}
	...
	public void saveUser(UsersDto usersDto) {
        ...
        // Dto -> Entity
        Users user = usersDto.toEntity(encodedPassword);
        // 유저 정보 저장
...
//		usersRepository.save(users);
	...
	public String usersIdChk(String userId) {
		...
		Users users = usersRepository.findByUserId(userId)
                .orElse(null);
        UsersDto usersDto = users != null ? UsersDto.fromEntity(users) : null;
	...
	public UsersDto updateInfo(UsersDto usersDto) {
		...
		return UsersDto.fromEntity(updated);
	}
