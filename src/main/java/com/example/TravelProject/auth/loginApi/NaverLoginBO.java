...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "lWLwIO5DLClCIOpDdaZJ";
	private final static String CLIENT_SECRET = "hUcrLtC_Dq";
	private final static String REDIRECT_URI = "http://localhost:9090/NaverCallback";
